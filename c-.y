...
%token <tokenData> BASE ID NUMCONST CHARCONST STRINGCONST
...
statement     : '\n'
              | BASE { cout << "BASE_Token" << endl; }
              | ID { cout << "ID_Token" << endl; }
              | NUMCONST { cout << "NUMCONST_Token" << endl; }
              | CHARCONST { cout << "CHARCONST_Token" << endl; }
              | STRINGCONST { cout << "STRINGCONST_Token" << endl; }
              ;
